        ...
        <div id="legals-wrapper">
            <div id="legals-content">
                ...
                <p>
                    ...
                    présentes modalités. Aussi, conformément à l’article n°6 de la
                    Loi n°2004-575 du 21 Juin 2004 pour la confiance dans l’économie
                    numérique, les responsables du présent site internet
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a> sont :
                </p>
                <p className="legals-title">
                    <span>
                        <b>Editeur du Site : </b>
                    </span>
                </p>
                <p>
                    Groupe GMB_S Numéro de SIRET : 2586914702 Responsable editorial
                    :
                </p>
                <p>
                    Groupe GMB_S 100k rue de la Monnaie, 75001 PARIS Téléphone
                    :012345798 - Fax : 0987654321 Email : tryagain@trash.mail Site
                    Web : <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a>
                </p>
                <p className="legals-title">
                    <b>
                ...
                <p>
                    Hébergeur : Groupe GEFOR 7 vis rue du Louvre, 75001 PARIS Site
                    Web : <a href="http://www.gefor.com">www.gefor.com</a>
                </p>
                <p className="legals-title">
                    <span>
                        <b>Développement</b>
                ...
                <p>
                    Groupe GMB_S Adresse : 100k rue de la Monnaie, 75001 PARIS Site
                    Web : <a href="http://www.nous.com">www.nous.com</a>
                </p>
                <p className="legals-title">
                    <span>
                ...
                <p>
                    Ce site (<a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a>)
                    est proposé en différents langages web (HTML, HTML5, Javascript,
                    CSS, etc…) pour un meilleur confort d'utilisation et un
                    graphisme plus agréable, nous vous recommandons de recourir à
                    des navigateurs modernes comme Internet explorer, Safari,
                    Firefox, Google Chrome, etc… Les mentions légales ont été
                    générées sur le site{" "}
                    <a
                    ...
                    &nbsp; Groupe GMB_S met en œuvre tous les moyens dont elle
                    dispose, pour assurer une information fiable et une mise à jour
                    fiable de ses sites internet. Toutefois, des erreurs ou
                    omissions peuvent survenir. L'internaute devra donc s'assurer de
                    l'exactitude des informations auprès de , et signaler toutes
                    modifications du site qu'il jugerait utile. n'est en aucun cas
                    responsable de l'utilisation faite de ces informations, et de
                ...
                <p>
                    Le site
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a> peut-être
                    amené à vous demander l’acceptation des cookies pour des besoins
                    de statistiques et d'affichage. Un cookies est une information
                    déposée sur votre disque dur par le serveur du site que vous
                    visitez. Il contient plusieurs données qui sont stockées sur
                ...
                <p>
                    Les sites internet de peuvent offrir des liens vers d’autres
                    sites internet ou d’autres ressources disponibles sur Internet.
                    Groupe GMB_S ne dispose d'aucun moyen pour contrôler les sites
                    en connexion avec ses sites internet. ne répond pas de la
                    disponibilité de tels sites et sources externes, ni ne la
                    garantit. Elle ne peut être tenue pour responsable de tout
                    ...
                    incombent pleinement à l'internaute, qui doit se conformer à
                    leurs conditions d'utilisation. Les utilisateurs, les abonnés et
                    les visiteurs des sites internet de ne peuvent mettre en place
                    un hyperlien en direction de ce site sans l'autorisation
                    expresse et préalable de Groupe GMB_S. Dans l'hypothèse où un
                    utilisateur ou visiteur souhaiterait mettre en place un
                    hyperlien en direction d’un des sites internet de Groupe GMB_S,
                    ...
                    Groupe GMB_S se réserve le droit d’accepter ou de refuser un
                ...
                <p>
                    ...
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a>.
                </p>
                <p>
                    Groupe GMB_S s’efforce de fournir sur le site www.ppe_m2l.com
                    des informations aussi précises que possible. les renseignements
                    figurant sur le site{" "}
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a> ne sont pas
                    exhaustifs et les photos non contractuelles. Ils sont donnés
                    sous réserve de modifications ayant été apportées depuis leur
                    mise en ligne. Par ailleurs, tous les informations indiquées sur
                    le site www.ppe_m2l.com
                    <span>
                        <b> </b>
                    </span>
                ...
                <p>
                    ...
                    email, à l’adresse tryagain@trash.mail, en décrivant le problème
                    de la manière la plus précise possible (page posant problème,
                    type d’ordinateur et de navigateur utilisé, …). Tout contenu
                    téléchargé se fait aux risques et périls de l'utilisateur et
                    sous sa seule responsabilité. En conséquence, ne saurait être
                    tenu responsable d'un quelconque dommage subi par l'ordinateur
                    de l'utilisateur ou d'une quelconque perte de données
                    ...
                    réseau Internet ne sauraient engager la responsabilité de Groupe
                    GMB_S.
                </p>
                <p className="legals-title">
                    <span>
                ...
                <p>
                    ...
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a>, incluant,
                    ...
                    sans l'accord exprès par écrit de Groupe GMB_S. Cette
                    ...
                    et suivants du Code de la propriété intellectuelle. Le
                ...
                <p>
                    ...
                    aux libertés, ce site n'a pas fait l'objet d'une déclaration
                ...
                <p>
                    ...
                    <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a> sont régies
                ...
                <p>
                    ...
                    Internet <a href="http://www.ppe_m2l.com">www.ppe_m2l.com</a>.
